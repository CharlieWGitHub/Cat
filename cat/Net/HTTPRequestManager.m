...
+ (void)uploadDataRequestWithUrl:(NSString *)url headers:(NSDictionary *)header parmeters:(id)parmeter dataArray:(NSArray *)dataArray dataType:(NSString *)datatype onOperation:(void (^)(AFHTTPRequestOperation * _Nonnull))onOperation completion:(void (^)(NSDictionary * _Nonnull))completion error:(void (^)(NSError * _Nonnull, long))onError{
