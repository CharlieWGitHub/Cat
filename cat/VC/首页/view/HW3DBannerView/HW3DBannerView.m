...
-(void)initialization{
    ...
    self.curPageControlColor = DEFAULTCOLOR;
...
-(void)createPageControl{
    ...
    _pageControl = [[UIPageControl alloc]initWithFrame:CGRectMake((self.frame.size.width-200), ZXMainScrollViewHeight - 30, 200, 30)];
