...
#define SSGestureLock_SelectedLineColor ColorWithHexString(@"1E90FF")//选择时候线的颜色
#define SSGestureLock_SelectedErrorLineColor ColorWithHexString(@"FF0000") //选择后错误线的颜色
