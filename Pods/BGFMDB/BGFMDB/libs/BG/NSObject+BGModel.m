...
{
    __block BOOL result;
    [[BGDB shareManager] saveObject:self
                        ignoredKeys:bg_getIgnoreKeys
...
+ (BOOL)bg_saveOrUpdateArray:(NSArray *_Nonnull)array
{
    ...
    __block BOOL result;
    [[BGDB shareManager] bg_saveOrUpateArray:array
                                 ignoredKeys:bg_getIgnoreKeys
                                    complete:^(BOOL isSuccess) {
                                      result = isSuccess;
                                    }];
...
+ (NSArray *_Nullable)bg_findAll:(NSString *_Nullable)tablename
{
    ...
    [[BGDB shareManager] queryObjectWithTableName:tablename
                                            class:[self class]
                                            where:nil
...
+ (NSArray *_Nullable)bg_find:(NSString *_Nullable)tablename where:(NSString *_Nullable)where
{
    ...
    __block NSArray *results;
    [[BGDB shareManager] queryWithTableName:tablename
                                 conditions:where
                                   complete:^(NSArray *_Nullable array) {
...
- (BOOL)bg_updateWhere:(NSString *_Nonnull)where
{
    ...
    __block BOOL result;
    [[BGDB shareManager] updateWithObject:self
                                valueDict:valueDict
                               conditions:where
                                 complete:^(BOOL isSuccess) {
                                   result = isSuccess;
...
+ (BOOL)bg_update:(NSString *_Nullable)tablename where:(NSString *_Nonnull)where
{
    ...
    [[BGDB shareManager] updateWithObject:object
                                valueDict:nil
                               conditions:where
                                 complete:^(BOOL isSuccess) {
                                   result = isSuccess;
...
+ (BOOL)bg_delete:(NSString *_Nullable)tablename where:(NSString *_Nullable)where
{
    ...
    __block BOOL result;
    [[BGDB shareManager] deleteWithTableName:tablename
                                  conditions:where
                                    complete:^(BOOL isSuccess) {
                                      result = isSuccess;
                                    }];
...
+ (BOOL)bg_drop:(NSString *_Nullable)tablename
{
    ...
    __block BOOL result;
    [[BGDB shareManager] dropWithTableName:tablename
                                  complete:^(BOOL isSuccess) {
                                    result = isSuccess;
                                  }];
    //关闭数据库
...
+ (bg_dealState)bg_update:(NSString *_Nullable)tablename version:(NSInteger)version
{
    ...
    if (version > oldVersion) {
        ...
        [[BGDB shareManager] refreshTable:tablename
                                    class:[self class]
                                     keys:keys
...
+ (bg_dealState)bg_copy:(NSString *_Nullable)tablename toTable:(NSString *_Nonnull)destTable keyDict:(NSDictionary *const _Nonnull)keydict append:(BOOL)append
{
    ...
    __block bg_dealState state;
    [[BGDB shareManager] copyTable:tablename
                                to:destTable
                           keyDict:keydict
                            append:append
                          complete:^(bg_dealState result) {
...
+ (BOOL)bg_updateArray:(NSArray *_Nonnull)array
{
    NSAssert(array && array.count, @"数组没有元素!");
    __block BOOL result;
    [[BGDB shareManager] updateObjects:array
                           ignoredKeys:bg_getIgnoreKeys
                              complete:^(BOOL isSuccess) {
                                result = isSuccess;
                              }];
...
+ (BOOL)bg_saveArray:(NSArray *)array IgnoreKeys:(NSArray *const _Nullable)ignoreKeys
{
    ...
    [[BGDB shareManager] saveObjects:array
                         ignoredKeys:ignoreKeys
                            complete:^(BOOL isSuccess) {
                              result = isSuccess;
                            }];
    //关闭数据库
...
{
    __block BOOL result;
    [[BGDB shareManager] updateObject:self
                           ignoreKeys:ignoreKeys
...
- (BOOL)bg_saveArrayWithName:(NSString *const _Nonnull)name
{
    if ([self isKindOfClass:[NSArray class]]) {
        __block BOOL result;
        [[BGDB shareManager] saveArray:self
                                  name:name
                              complete:^(BOOL isSuccess) {
                                result = isSuccess;
                              }];
...
+ (BOOL)bg_addObjectWithName:(NSString *const _Nonnull)name object:(id const _Nonnull)object
{
    ...
    __block BOOL result;
    [[BGDB shareManager] saveArray:@[ object ]
                              name:name
                          complete:^(BOOL isSuccess) {
                            result = isSuccess;
                          }];
...
+ (NSArray *)bg_arrayWithName:(NSString *const _Nonnull)name
{
    ...
    [[BGDB shareManager] queryArrayWithName:name
                                   complete:^(NSArray *_Nullable array) {
...
{
    __block BOOL result;
    [[BGDB shareManager] dropSafeTable:name
                              complete:^(BOOL isSuccess) {
                                result = isSuccess;
                              }];
    //关闭数据库
...
- (BOOL)bg_saveDictionary
{
    if ([self isKindOfClass:[NSDictionary class]]) {
        __block BOOL result;
        [[BGDB shareManager] saveDictionary:self
                                   complete:^(BOOL isSuccess) {
                                     result = isSuccess;
                                   }];
        //关闭数据库
...
+ (BOOL)bg_clearDictionary
{
    ...
    [[BGDB shareManager] dropSafeTable:tableName
                              complete:^(BOOL isSuccess) {
                                result = isSuccess;
                              }];
    //关闭数据库
